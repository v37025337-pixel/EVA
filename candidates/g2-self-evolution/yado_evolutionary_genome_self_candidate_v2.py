...
class YADOEvolutionaryGenomeV1:
    ...
    def evolve_once(self):
        ...
        selected = 'CHILD' if fitness['fitness_gain'] > 0 and fitness['all_regressions_pass'] and (min(fitness['child'].values()) >= 1.0) and (child.get('mutation_count', 0) > 0) else 'PARENT'
