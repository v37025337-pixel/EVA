...
TASK=REPO/'architecture/yado-g2-coding-spec-generalization-real-code-transfer-v2-request.json'
PARENT=REPO/'candidates/kernel-self-generated/g2-coding-self-generated-test-oracle-v1.json'
HEAD=REPO/'canonical/yado-main-head-g2.json'
OUT=REPO/'candidates/kernel-self-generated/g2-coding-spec-generalization-real-code-transfer-v2.json'
EXP=REPO/'experience/yado-coding-real-code-transfer-v2.json'
...
def expr_ok(n):
    ...
    if isinstance(n,ast.Constant):
        return isinstance(n.value,int) and not isinstance(n.value,bool) and -4<=n.value<=4
...
gene={
 'schema':'yado.g2.coding_spec_generalization_real_code_transfer_gene.v2',
 'gene_id':'GENE-G2-CODING-REAL-CODE-TRANSFER-V2-'+digest({'episodes':executed,'parent':parent_gene['gene_digest']})[:16],
 'organ':'THINKING',
...
status='PASS_SHADOW_G2_CODING_SPEC_GENERALIZATION_REAL_CODE_TRANSFER_V2' if passed else 'WITHHOLD_G2_CODING_SPEC_GENERALIZATION_REAL_CODE_TRANSFER_V2'

experience={
 'schema':'yado.g2.coding_real_code_transfer.experience.v2','status':'TRAINED' if passed else 'WITHHOLD',
...
report={
 'schema':'yado.g2.coding_spec_generalization_real_code_transfer.v2','status':status,'task':task,
 ...
 'next_required_capability':'G2_CODING_WHOLE_FUNCTION_REAL_REPAIR_V1' if passed else 'G2_CODING_SPEC_GENERALIZATION_AND_REAL_CODE_TRANSFER_V3',
