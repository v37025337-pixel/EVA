...
FAB='RUNTIME-G2-UNIFIED-EXECUTION-FABRIC-V5'
...
COG='RUNTIME-G2-EXPERIENCE-CONDITIONED-COGNITIVE-LAYER-V5'
...
checks={
 ...
 'execution_fabric_canonical':core.get('execution_fabric_v5',{}).get('status')=='CANONICAL_ACTIVE' and FAB in active,
 ...
 'frontier_preserved':head.get('current_frontier')=='KERNEL_G2_RAW_REPRESENTATION_V4_ROBUSTNESS_SELF_EVOLUTION_V2' and ledger.get('open_deficits')==['KERNEL_G2_RAW_REPRESENTATION_V4_ROBUSTNESS_SELF_EVOLUTION_V2'],
...
report={
 ...
 'execution_fabric':core.get('execution_fabric_v5'),
