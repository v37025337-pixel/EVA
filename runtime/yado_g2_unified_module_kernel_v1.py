...
CAP_FABRIC='RUNTIME-G2-UNIFIED-EXECUTION-FABRIC-V5'
CAP_API=CAP_API_V1
...
MODULE_REGISTRY={
 ...
 CAP_FABRIC:('RUNTIME','runtime/yado_g2_unified_execution_fabric_v5.py'),
...
class UnifiedYADOModuleKernelV1:
    ...
    def __init__(self,router_program,scalar_program,relation_program,repo_root:Path|str|None=None):
        ...
        self.fabric=G2UnifiedExecutionFabricV5(self.base_runtime)
