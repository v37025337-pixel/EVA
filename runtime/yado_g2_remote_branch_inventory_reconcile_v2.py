...
def is_ancestor(ancestor: str, descendant: str) -> bool:
    ...
    if result.returncode not in (0, 1):
        raise RuntimeError('ANCESTRY_CHECK_FAILED:' + result.stderr[-500:])
