...
def main():
    profile=CapabilityBoundaryProfile().fit(make_observations(seed=7711,n=2200))
    tasks=make_tasks(8808293601,6000)
    ...
    result={'seed':8808293601,'fresh_used_for_selection':False,'cases':6000,'candidate':cand,'verbal_only':base,'empty_profile_ablation':empty}
    ...
    Path('yado_metacognitive_fresh_holdout_v1_report.json').write_text(json.dumps(result,indent=2,sort_keys=True))
